    ...
    <div class="box box-primary">
      ...
      <div class="box-body table-responsive no-padding">
        ...
        <div class="col-md-12">
         ...
         {!!Form::model($flyer,array('route' => array('siddhivinayak.masters.flyer.update', $flyer->id), 'method' => 'PUT','files'=>true,'id'=>'edit-form','onSubmit'=>'return validate()'))!!}
...
<div class="col-md-12" style="margin-top: 10px;">
         <div class="col-md-8" id="details_div">
           @if($flyer->flyer_display_attachment)
           <?php $flyer_display_attachment=getSubCategoryUploadedPath($flyer->flyer_display_attachment) ?>
           <img src="{{$flyer_display_attachment}}" id="disp_round_attachment" height="200px" width="200px" >
           @endif
         </div>
       </div>
...
var gallery = <?php echo json_encode($flyer) ?>;
...
console.log(11111111);
  ...
  var ajax = $.ajax({
    type: 'post',
    url:'{{URL::route("siddhivinayak.masters.flyer.uploadFlyerImage")}}',

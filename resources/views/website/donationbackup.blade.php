...
<div class="grid_3 grid_5 wthree">
                  <center> <h3>PLEASE DONATE GENEROUSLY TO SUPPORT YOUR TEMPLE!
                    ...
                    <div class="col-md-12 agileits-w3layouts">
                        <h4 style="color:#3D3187;"><b>DONATIONS TOWARDS TEMPLE UPCOMING PROJECTS:</b>  <span style="margin-left:430px;"> 
                        <a href="{{ asset('website/images/Appeal.pdf') }}" target="_blank"><span style="font-size: 20px; background-color: orange;" class="button2"><b> Appeal Letter</b></span></a></span></h4><br>

...
<html xmlns="http://www.w3.org/1999/xhtml" ng-app="app" itemscope="" itemtype="http://qrco.de/bbMOAV?trackSharing=1" class="ng-scope"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style><style id="stndz-style"></style>
    <link rel="stylesheet" type="text/css" 
    
    href="{{ asset ("/website/satyanarayana_marathe/template_normal.min.css") }}">
...
/*<![CDATA[*/
YII_CSRF_TOKEN='3c2708ec919887e327edc2e7d3c054e51bc17629';
/*]]>*/
</script>
<title>Satyanarayana Marathe</title>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="{{ asset('website/images/logo_final_Copy.jpg') }}">
            <link rel="apple-touch-icon" href="http://qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054">
        <link rel="apple-touch-icon" sizes="76x76" href="http://qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054">
        <link rel="apple-touch-icon" sizes="120x120" href="http://qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054">
        <link rel="apple-touch-icon" sizes="152x152" href="http://qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054">
    
    <!--Facebook meta-->
    <meta property="og:url" content="http://qrco.de/bbMOAV?trackSharing=1">
    <meta property="og:title" content="Satyanarayana Marathe">
    <meta property="og:description" content="Founder President Of Siddhivinaayak Temple Glen Burnie Maryland USA.

V P Of SASI .

Want Explain pooja Significance in English , Sanskrit , Marathi,Hindi , Tamil, Kannada, Tulu, Konkani,&amp; Some Extend In Telugu.">
    <meta property="og:image" content="http://qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054">
    <meta property="og:image:width" content="200">
    <meta property="og:image:height" content="200">

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:url" content="http://qrco.de/bbMOAV?trackSharing=1">
    <meta name="twitter:title" content="Satyanarayana Marathe">
    <meta name="twitter:description" content="Founder President Of Siddhivinaayak Temple Glen Burnie Maryland USA.

V P Of SASI .

Want Explain pooja Significance in English , Sanskrit , Marathi,Hindi , Tamil, Kannada, Tulu, Konkani,&amp; Some Extend In Telugu.">
    <meta name="twitter:image" content="http://qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta itemprop="name" content="Satyanarayana Marathe">
    <meta itemprop="description" content="Founder President Of Siddhivinaayak Temple Glen Burnie Maryland USA.

V P Of SASI .

Want Explain pooja Significance in English , Sanskrit , Marathi,Hindi , Tamil, Kannada, Tulu, Konkani,&amp; Some Extend In Telugu.">
    <meta itemprop="image" content="http://qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054">
...
<!-- 
  ...
  <script>
    function show() {
      document.getElementById('id1').style.maxHeight = "1000px";
    }
  </script>
 -->
...
<div class="loading-welcome active welcome-screen" ng-style="{&#39;background-color&#39;: view.code.welcome_extra.background || view.welcome_extra.background}" style="background-color: rgb(255, 255, 255); display: none;">
    <div class="progress">
        <div class="loading-bar indeterminate" ng-style="{&#39;background-color&#39;: view.code.color1 || view.color1}" style="background-color: rgb(255, 138, 101);"></div>
    </div>
    <div class="helper"></div>
    <img id="welcomeImg" imageonload="" ng-src="//qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452882_1.png?0.11709679776461246" ng-style="{
            ...
            }" src="{{ asset ("/website/satyanarayana_marathe/5452882_1.png") }}" style="max-width: 100px; max-height: 100px; display: inline;">
</div><div class="vcard-template style2" id="rootElement">
    <div class="bgd-shadow"></div>
    <div class="page-home page">
<!--         <div class="vcard-header gradient-red-orange-bg"  style="background-image: url(website/images/mahayaga.jpeg);">
 -->
...
<!-- 
   ...
   <div class="vcard-header gradient-red-orange-bg"  style="background-color: darkgoldenrod"> -->
        <div class="vcard-header gradient-red-orange-bg"  style="background-image: url(website/images/bannersm.jpeg);">


              <!-- <div class="vcard-header gradient-red-orange-bg" ng-style="getBackgroundColor();" style="background: linear-gradient(45deg, rgb(255, 138, 101) 0%, rgb(255, 138, 101) 1%, rgb(162, 162, 34) 100%);"> -->
            <div class="vcard-header-wrapper" style="background-color: orangered;">
                <div class="vcard-top-info">
                    ...
                    <div class="img ng-hide" ng-show="loadDemo &amp;&amp; view.avatar" ng-click="!loadDemo ?  &#39;&#39; : callAction($event,&#39;headerButton-avatar&#39;)" ng-style="{&#39;background&#39;:view.avatar?&#39;url(&#39;+view.avatar+&#39;)&#39;:&#39;none&#39;}" style="background: url(&quot;//qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054&quot;);"></div>
                    <div class="img" ng-show="!loadDemo &amp;&amp; view.avatar" ng-style="{&#39;background&#39;:view.avatar?&#39;url(&#39;+view.avatar+&#39;)&#39;:&#39;none&#39;}" style="background: url(&quot;//qrcgcustomers.s3-eu-west-1.amazonaws.com/account7018784/5452781_1.png?0.20687009899707054&quot;);"></div>
                    <h2 class="name dynamicTextColor ng-binding" ng-show="view.firstname || view.lastname">Satyanarayana
                        Marathe</h2>

                    <h2 class="name dynamicTextColor ng-binding ng-hide" ng-hide="view.firstname || view.lastname">Siddhivinaayak Temple</h2>
                    <h6 class="title dynamicTextColor ng-binding">Religious Leader</h6>
                </div>
                <div class="vcard-functions" ng-show="view.numbers_mobile ||  view.numbers_phone ||  view.email || ((view.city ||view.street|| view.zip|| view.country) &amp;&amp; view.show_directions)">
                    <div class="vcard-functions-wrapper">
                        <a class="header-button ng-hide" ng-show="loadDemo &amp;&amp; (view.numbers_mobile || view.numbers_phone)" ng-click="!loadDemo ?  &#39;&#39; : callAction($event,&#39;headerButton-call&#39;)" ng-style="{&#39;transition&#39;: loadDemo ? &#39;none&#39; : &#39;all 0.15s ease&#39;}" style="transition: all 0.15s ease;">
    <i class="icon-phone dynamicTextColor"></i>
    <small class="dynamicTextColor">Call</small>
</a>

<a class="header-button ng-hide" ng-show="loadDemo &amp;&amp; (view.email)" ng-click="!loadDemo ?  &#39;&#39; : callAction($event,&#39;headerButton-email&#39;)" ng-style="{&#39;transition&#39;: loadDemo ? &#39;none&#39; : &#39;all 0.15s ease&#39;}" style="transition: all 0.15s ease;">
    <i class="icon-send dynamicTextColor"></i>
    <small class="dynamicTextColor">Email</small>
</a>

<a href="tel:240-350-5096" ng-show="!loadDemo &amp;&amp; (view.numbers_mobile || view.numbers_phone)">
    <i class="dynamicTextColor"></i>
    <small class="dynamicTextColor">Call</small>
</a>

<a href="mailto:uspooja@yahoo.com?subject=From%20my%20vCard&amp;body=" target="_newEmail" ng-show="!loadDemo &amp;&amp; (view.email)">
    <i class="dynamicTextColor"></i>
    <small class="dynamicTextColor">Email</small>
</a>

<a ng-show="((view.street || view.city )&amp;&amp; view.show_directions)" ng-click="callAction($event, &#39;mapAction&#39;)" class="last-element">
    <i class="dynamicTextColor"></i>
    ...
    <div class="vcard-row" ng-show="view.bio">
        <h4 ng-bind-html="view.bio|nl2br" class="ng-binding">Founder President Of Siddhivinaayak Temple Glen Burnie Maryland USA.<br><br>V P Of SASI .<br><br>Want Explain pooja Significance in English , Sanskrit , Marathi,Hindi , Tamil, Kannada, Tulu, Konkani,&amp; Some Extend In Telugu.</h4>
    </div>
    <div class="vcard-separator" ng-show="view.bio"></div>
    <div class="vcard-row" ng-show="view.numbers_mobile">
        <i class=""></i>
        <h4><a href="tel:240-350-5096" class="ng-binding">240-350-5096</a></h4>
        <small>Mobile</small>
    </div>
    <div class="vcard-row pt0" ng-show="view.numbers_phone">
        ...
        <h4><a href="tel:410-766-1003" class="ng-binding">410-766-1003</a></h4>
    ...
    <div class="vcard-row" ng-show="view.email">
        <i class=""></i>
        <h4><a href="mailto:uspooja@yahoo.com" target="_newLink" class="ng-binding">uspooja@yahoo.com</a></h4>
        <small>Email</small>
    </div>
    ...
    <div class="vcard-row" ng-show="view.company">
        <i class=""></i>
        <h4 class="ng-binding">Siddhivinaayak Temple</h4>
        <small ng-show="view.job" class="ng-binding">Religious Leader</small>
    </div>
    <div class="vcard-separator" ng-show="view.venue || view.city || view.state || view.zip || view.street || view.country"></div>
    <div class="vcard-row" ng-show="view.venue || view.city || view.state || view.zip || view.street || view.country">
        <label></label>
        <i class=""></i>
        <h4 class="ng-binding"></h4>
        <h4 class="ng-binding">Stewart Lane Northeast 1003</h4>
        <h4 class="ng-binding">Glen Burnie<span ng-show="view.state || view.zip" class="ng-binding"><span ng-show="view.city">,</span> MD 21060</span>
        </h4>
        <h4 class="ng-binding">United States</h4>

        <!-- ngIf: view.show_directions --><div class="floated-container ng-scope" ng-if="view.show_directions" ng-show="(view.street &amp;&amp; view.city) || (view.city &amp;&amp; view.country) || view.city || view.country">
            <a class="event-slim-button ripplelink left_15 mt-10" ng-style="{&#39;color&#39;: isColorLight(view.color2) ? &#39;black&#39; : view.color2}" ng-click="callAction($event, &#39;mapAction&#39;)" style="color: rgb(76, 7, 240);">
                Show on map            </a>
    ...
    <div class="vcard-row" ng-show="view.website">
        <i class=""></i>
        <h4><a href="http://www.uspooja.com/" target="_newLink" class="ng-binding">www.uspooja.com</a></h4>
        <small>Website</small>
    </div>
    ...
    <div id="socialmedialinksContainer">
        <div class="vcard-social" style="margin-bottom:20px;">
            ...
            <div class="socialMedia-container ng-hide" ng-show="view.code.channels.length &gt; 0">
    ...
    <div class="fixed-blur-bgd">
        <div class="chat">
            <div class="fab-body fab-step1">
                <div class=""></div>
                <div class="fab-header" ng-style="{color: isColorLight(view.color2) ? &#39;black&#39; : view.color2}" style="color: rgb(76, 7, 240);">
                ...
                <ul>
                    <li open-popup="email" class="addContactAction" ng-click="!loadDemo ? toggleFabStep(1,2) : callAction($event, &#39;addContactAction&#39;)">
                        <i class=""></i>
                        <a href="http://qrco.de/bbMOAV?trackSharing=1">
                            Send by Email                        </a>
                    </li>
                    <li ng-click="loadDemo ? callAction($event, &#39;addContactAction&#39;) : &#39;&#39;" class="addContactAction">
                        <i class=""></i>
                        <!-- ngIf: !loadDemo --><a ng-if="!loadDemo" href="http://qrco.de/handlePost/bbMOAV/?download=true" rel="external" class="ng-scope">
            ...
            <div class="fab-body fab-step2" style="display:none;">
                <div class=""></div>
                <div class="" ng-click="toggleFabStep(2,1)"></div>
                <div class="fab-header mt-10" ng-style="{color: isColorLight(view.color2) ? &#39;black&#39; : view.color2}" style="color: rgb(76, 7, 240);">
                ...
                <form action="http://qrco.de/bbMOAV?trackSharing=1#" method="post" class="ng-pristine ng-valid ng-valid-email">
                    ...
                    <input type="hidden" id="YII_CSRF_TOKEN" name="YII_CSRF_TOKEN" value="3c2708ec919887e327edc2e7d3c054e51bc17629">
    ...
    <a id="prime" class="fab" ng-style="{background:view.color2||&#39;#607d8b&#39;}" style="background: rgb(76, 7, 240);">
        <span class="hidden-xs" ng-style="{&#39;color&#39;: isColorLight(view.color2) ? &#39;black&#39; : &#39;white&#39;}" style="color: white;">
            <i class="" ng-style="{&#39;color&#39;: isColorLight(view.color2) ? &#39;black&#39; : &#39;white&#39;}" style="color: white;"></i>
            Download vCard        </span>
    ...
    <div class="fixed-blur-bgd">
        <div class="chat">
            <div class="fab-body">
                <div class=""></div>
                <div class="fab-header" ng-style="{&#39;color&#39;: isColorLight(view.color2) ? &#39;black&#39; : view.color2}" style="color: rgb(76, 7, 240);">Share</div>
                <ul class="ssk-block ssk-md" data-url="http://qrco.de/bbMOAV?trackSharing=1" data-text="">
                    <li>
                        <i class=""></i>
                        <a href="http://qrco.de/bbMOAV?trackSharing=1" class="ssk ssk-text ssk-facebook">Facebook</a>
                    </li>
                    <li>
                        <i class=""></i>
                        <a href="http://qrco.de/bbMOAV?trackSharing=1" class="ssk ssk-text ssk-twitter">Twitter</a>
                    </li>
                    <li>
                        <i class=""></i>
                        <a href="http://qrco.de/bbMOAV?trackSharing=1" class="ssk ssk-text ssk-google-plus">Google+</a>
                    </li>
                    <li>
                        <i class=""></i>
                        <a href="whatsapp://send?text=http://qrco.de/bbMOAV?trackSharing=1" class="ssk ssk-whatsapp">Whatsapp</a>
                    </li>
                    <li>
                        <i class=""></i>
                        <a href="mailto:?body=http://qrco.de/bbMOAV?trackSharing=1" target="_blank">Email</a>
                    </li>
                    <li>
                        <i class=""></i>
                        <input id="shortUrl" value="http://qrco.de/bbMOAV" readonly="">
    ...
    <div class="page-maps page hidden">
        <div class="devent-map-header">
            <div class="event-section-title " ng-style="getBackgroundColor();" style="background: linear-gradient(45deg, rgb(255, 138, 101) 0%, rgb(255, 138, 101) 1%, rgb(162, 162, 34) 100%);">
                <div class="event-content-container">
                    <i class="" ng-click="switchPages(&#39;page-maps&#39;,&#39;page-home&#39;, false)"></i>
    ...
    <div class="vcard-row" ng-show="view.venue || view.city || view.state || view.zip">
        ...
        <h4 class="ng-binding">United States</h4>
        <input id="addressValue" type="hidden" ng-value="view.street + &#39;,&#39;  + view.city + &#39;,&#39; + view.country " value="Stewart Lane Northeast,Glen Burnie,United States">
        <div class="floated-container">
            <a class="event-slim-button ripplelink left_20 mt-10" ng-style="{&#39;color&#39;: isColorLight(view.color2) ? &#39;black&#39; : view.color2}" ng-click="callAction($event, &#39;redirectToMap&#39;)" style="color: rgb(76, 7, 240);">
                Show directions            </a>
        </div>
    </div>
</div>
                        ...
                        <div class="fixed-blur-bgd">
                            <div class="dialog-container">
                                <div class="fab-body">
                                    ...
                                    <a class="event-slim-button ripplelink mt-10 pull-right" ng-style="{&#39;color&#39;: isColorLight(view.color2) ? &#39;black&#39; : view.color2}" ng-click="dialogRedirectCallback(false)" style="color: rgb(76, 7, 240);">
                                        No                                    </a>
                                    <a class="event-slim-button ripplelink mt-10 pull-right" ng-style="{&#39;color&#39;: isColorLight(view.color2) ? &#39;black&#39; : view.color2}" ng-click="dialogRedirectCallback(true, &#39;https://maps.google.com/maps?daddr=&#39;+getMapAddress())" style="color: rgb(76, 7, 240);">
                                        Yes                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <!--    --></div>
<script type="text/javascript" src="{{ asset ("/website/satyanarayana_marathe/jquery.min.js") }}"></script>
<script type="text/javascript" src="{{ asset ("/website/satyanarayana_marathe/angular.rendering.min.js") }}"></script>
<script type="text/javascript">
/*<![CDATA[*/
    ...
    app.controller('ComplexController', function ($scope, $controller, $sce, $rootScope, $filter, previewService, $window) {
        ...
        json_data = {"show_directions":true,"showPreview":1,"form":[{"section_design":{"fold":false}},{"section_information":{"fold":false}},{"section_social":{"fold":true}},{"section_welcome_screen":{"fold":false}},{"section_advance_options":{"fold":false}}],"color1":"#ff8a65","color2":"#4c07f0","avatar":"\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account7018784\/5452781_1.png?0.20687009899707054","avatar_extra":{"zoom":100,"background":"#ffffff"},"address":{"autocomplete":"1003 stewart Ln"},"code":{"channels":[],"welcome_extra":{"zoom":50,"background":"#ffffff"}},"welcome_screen":"\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account7018784\/5452882_1.png?0.11709679776461246","sharing":true,"show_gradient":true,"color1b":"#cbca2b","firstname":"Satyanarayana","lastname":"Marathe","numbers_mobile":"240-350-5096","numbers_phone":"410-766-1003","email":"uspooja@yahoo.com","company":"Siddhivinaayak Temple","job":"Religious Leader","street_number":"1003","street":"Stewart Lane Northeast","city":"Glen Burnie","state":"MD","country":"United States","zip":"21060","website":"www.uspooja.com","bio":"Founder President Of Siddhivinaayak Temple Glen Burnie Maryland USA.\n\nV P Of SASI .\n\nWant Explain pooja Significance in English , Sanskrit , Marathi,Hindi , Tamil, Kannada, Tulu, Konkani,& Some Extent In Telugu."};
